...
engine = create_engine(
    "postgresql://am:12345678@localhost:5432/library")
...
class BookAuthor(Base):
    ...
    def __repr__(self):
        return "<BookAuthor(bookauthor_id='{0}', author_first_name='{1}', author_last_name='{2}', book_title='{3})'>".format(self.bookauthor_id, self.author.first_name, self.author.last_name, self.book.title)
